...
<script type="text/javascript">
	var imgs = ["${pageContext.request.contextPath}/resources/img/title1.png", "${pageContext.request.contextPath}/resources/img/title2.png", "${pageContext.request.contextPath}/resources/img/title3.png"
	];
	var i = 1;
