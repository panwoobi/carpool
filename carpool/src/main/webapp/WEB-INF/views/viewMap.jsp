...
<div id="wrap" class="section">
	<div id="map" style="width: 100%; height: 500px;">
		<div class="search" style="">
			<input id="address1" type="text" placeholder="출발할 주소" value="" /> <input id="submit1" type="button" value="주소 검색" /><br> <input id="address2" type="text" placeholder="도착할 주소" value="" /> <input id="submit2" type="button" value="주소 검색" /><br> <input id="submit3" type="submit" value="주소사용하기"> <input type="hidden" id="s_x"> <input type="hidden" id="s_y"> <input type="hidden" id="e_x"> <input type="hidden" id="e_y">
		</div>
	</div>
</div>
