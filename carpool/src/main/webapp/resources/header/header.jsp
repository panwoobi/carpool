...
<header>
	...
	<div class="container">
		<div id="navibar">
			<table id="loginBar">
				<tr>
					<td>
						<p id="title">
							<a href="${pageContext.request.contextPath }/content/main.jsp"><img src="${pageContext.request.contextPath }/img/kitri_carpool.png"></a>
						</p>
					</td>
					<td style="text-align: right" colspan="2"><c:choose>
							<c:when test="${empty sessionScope.m }">
								<form id="login" action="${pageContext.request.contextPath }/MemberLoginController" method="post">
									<input type="text" name="id" placeholder="아이디"><br> <input type="password" name="pwd" placeholder="비밀번호"><br> <br> <input type="submit" value="Login"> <input type="button" id="join" value="Join">
								</form>
							</c:when>
		...
		<div class="container">
			<table id="menu">
				<tr>
					<td id="menu1" onclick="menuClick(1)"><img src="${pageContext.request.contextPath }/img/menu1.png"></td>
					<td id="menu2" onclick="menuClick(2)"><img src="${pageContext.request.contextPath }/img/menu2.png"></td>
					<td id="menu3" onclick="menuClick(3)"><img src="${pageContext.request.contextPath }/img/menu3.png"></td>
					<td id="menu4" onclick="menuClick(4)"><img src="${pageContext.request.contextPath }/img/menu4.png"></td>
					<td id="menu5" onclick="menuClick(5)"><img src="${pageContext.request.contextPath }/img/menu5.png"></td>
				</tr>
			</table>
		</div>
	</div>
